    ...
    ui(new Ui::HelpForm)
{
    ...
    label->setText("\n    Das Produkt dient zur Bilderklassifizierung auf heterogenen Plattformen mittels neuronaler"
                   "\nNetze (u.a. AlexNet). Es kann zwischen verschiedenen Betriebsmodi ausgewählt werden:"
                   " \n\n     Optimaler Modus: der optimale Modus, in "
                   ...
                   "\n\n     Hohe Energieeffizienz: der Modus, in dem alle verfügbaren Intel Movidius Neural Compute\nSticks benutzt werden."
                   ...
                   " der optimale Modus.\n    Der Trainingsdatensatz muss folgendendermaßen formatiert sein:"
