    ...
    ui(new Ui::HelpForm)
{
   ...
   /*font_2.setPointSize(13);
    ...
    label_2->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::);
  ...
  /*h_panel->addWidget(label_2);
    h_panel->addWidget(label_3);
    h_panel->addWidget(label_4);
    h_panel->addWidget(label_5);
    h_panel->addWidget(label_6);
    h_panel->addWidget(label_7);*/
